...
void StudioProjectScene::Init()
{
	...
	ScreenSplit[0]->Character->scale.Set(30, 48, 1);
	ScreenSplit[1]->Character->scale.Set(30, 48, 1);
	ScreenSplit[2]->Character->scale.Set(30, 48, 1);
	ScreenSplit[3]->Character->scale.Set(30, 48, 1);
