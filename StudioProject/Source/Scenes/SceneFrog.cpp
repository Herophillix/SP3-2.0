...
void SceneFrog::Init()
{
	...
	meshList[GEO_FROG] = MeshBuilder::GenerateCircle("frog", Color(1, 1, 1), 1.f);
...
void SceneFrog::Update(double dt)
{
	...
	//if (Frog->getJump())
	//{
	//	Frog->Frog_vel += m_grav * (float)dt;
	//}

	UpdateRock(dt);
	cout << Frog->getInvincible() << endl;
